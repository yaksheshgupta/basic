        ...
        try:
            ...
            try:
                if "wikipedia" in text:
                    ...
                    op=text.replace("open","")
                    appscript.app('Terminal').do_script(('open -a '+op))
                    k.write(" ")
                    k.write("exit")
                    ...
                    if "close web"in text:
                        driver.quit()
                    else:
                        text=text.replace("close","")
                        appscript.app('Terminal').do_script(('killall'+text))
                ...
                elif "check and start j3" in text:
                    engine.say("initialising command sequence for j3")
                    t.sleep(3)
                    engine.say("no error found in j3")
                    t.sleep(1)
                    engine.say("jarvis 3 is ready to use")
                    t.sleep(1)
                    #start jarvis 3
                    engine.say("starting jarvis 3 in 3 seconds")
                    t.sleep(3)
                    appscript.app('Terminal').do_script("cd Desktop/yakshesh/")
                    k.write("python3 j3.py")
                    k.press_and_release("enter")
                elif "a"=="a":
